...
const styles = StyleSheet.create({
  ...
  categoryName: { color: themeColors.foreground, fontSize: 21, fontWeight: '800' },
  chevron: { color: themeColors.primary, fontSize: 28, fontWeight: '500', lineHeight: 30 },
  ...
  editorActions: { gap: 8 },
  editorTitle: { color: themeColors.foreground, fontSize: 18, fontWeight: '800' },
  ...
  input: { backgroundColor: themeColors.surface, borderColor: themeColors.borderStrong, borderRadius: 12, borderWidth: 1, color: themeColors.foreground, fontSize: 16, minHeight: 48, paddingHorizontal: 14 },
